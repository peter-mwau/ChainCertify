        ...
        <div className="course-professional" id="certificate">
          <div className="overlap-wrapper">
            <div className="overlap">
              ...
              <img className="group-4" src="/group-329.png" alt="Group 329" />
              <div className="group-5">
                <div className="overlap-2">
                  <div className="overlap-3">
                    <div className="text-wrapper">{issueDate}</div>
                  ...
                  <div className="overlap-5">
                    ...
                    <div className="group-8">
                      <div className="overlap-group-3">
                        ...
                        <div className="decentralization">{courseName}</div>
                      </div>
                    </div>
                      ...
                      <div className="group-12">
                        <div className="overlap-7">
                          <div className="overlap-8">
                            <p className="p">
                              Director Strategy and Quality Assurance
                            </p>
