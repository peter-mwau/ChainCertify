...
const Contact = () => {
  ...
  const handleInputChange = (e) => {
    ...
    // Update the correct state based on the input's name attribute
  ...
  return (
    <>
      <section className="py-24 pt-[100px] transition-all duration-1000 dark:bg-cyan-700 h-[100vh]">
        <div className="mx-auto max-w-7xl px-4 md:w-[70%] lg:mx-auto md:ml-[250px] md:items-center md:mx-auto sm:px-6 lg:px-8 shadow-md dark:shadow-white rounded-md p-5">
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
            <div className="flex items-center lg:mb-0 mb-10">
              <div className="">
                <h4 className="text-gray-600 dark:text-gray-200 text-base font-medium leading-6 mb-4 lg:text-left text-center">
                  Contact Us
                </h4>
                <h2 className="text-gray-900 dark:text-gray-300 font-manrope text-4xl font-semibold leading-10 mb-9 lg:text-left text-center">
                  Reach Out To Us
                </h2>
                <form action="" onSubmit={sendEmail}>
                  ...
                  <input
                    ...
                    className="w-full h-14 shadow-sm text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-md border border-gray-200 focus:outline-none py-2 px-4 mb-8"
                    placeholder="Email"
                  />
                  <input
                    name="subject"
                  ...
                  <textarea
                    ...
                    value={message}
                    onChange={handleInputChange}
                    className="w-full h-48 shadow-sm resize-none text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-md border border-gray-200 focus:outline-none px-4 py-4 mb-8"
                    placeholder="Message..."
                  ></textarea>
                  <button className="w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-md bg-cyan-950 dark:bg-yellow-500 shadow transition-all duration-700">
                    Submit
                  </button>
                </form>
              </div>
            </div>
            <div className="lg:max-w-xl w-full h-[600px] flex items-center justify-center  bg-cover bg-no-repeat bg-[url('/Africa1.jpg')] ">
              <div className="">
                <div className="lg:w-96 w-auto h-auto bg-white shadow-xl lg:p-6 p-4">
                  <div className="flex flex-row gap-3 mx-auto py-5 justify-center items-center">
                    <img src="/Africa1.jpg" className="w-10" />
                    <p className="my-auto font-semibold text-lg">
                      Assign Track Systems
                    </p>
                  </div>
